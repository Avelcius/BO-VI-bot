...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('safebooru')
        .setDescription('Получить случайный пост с safebooru с тегами')
    ...
    async execute(interaction) {
        ...
        const limit = interaction.options.getInteger('limit') || 4000000; // по умолчанию 1
        ...
        const url = `https://safebooru.org/index.php?page=dapi&s=post&q=index&json=1&limit=${limit}&pid=${randomPid}&deleted=${deleted}&tags=${tags}`;
        ...
        try {
            ...
            if (response.data.length > 0) {
                ...
                const postUrl = `https://safebooru.org/index.php?page=post&s=view&id=${post.id}`;
